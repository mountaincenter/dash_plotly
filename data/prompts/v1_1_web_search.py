"""
Grok Prompt v1.1 - Web Search + X Search Edition
リアルタイム情報取得版: web_search() + x_search() による一次情報優先

Created: 2025-11-02
Based on: v1_0_baseline.py + premium user prioritization
Description:
...
- **最低40%（5銘柄以上）がプレミアムユーザー言及銘柄である必要あり**
"""
...
- x_searchツールで以下のクエリを実行:
  ...
  ```
- 複数人言及を最優先（スコア+100点）
- **最低5銘柄以上（40%）がプレミアムユーザー言及銘柄である必要あり**
