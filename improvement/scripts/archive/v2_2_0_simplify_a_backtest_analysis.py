#!/usr/bin/env python3
"""
v2.2.0_simplify_a: 引き算アプローチ（RSI + 出来高のみ）
ベース: v2.1.1から SMA5を除外
...
OUTPUT_FILE = OUTPUT_DIR / 'v2_2_0_simplify_a_backtest_results.parquet'
...
def main():
    print("=" * 60)
    print("v2.2.0_simplify_a: RSI + 出来高のみ")
    print("=" * 60)
