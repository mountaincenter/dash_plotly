...
DATA_FILE = BASE_DIR / 'improvement' / 'data' / 'v2_1_1_backtest_results.parquet'
OUTPUT_FILE = BASE_DIR / 'improvement' / 'v2_1_1_static_backtest_report.html'
...
<body>
    <div class="container">
        <header>
            <h1>📊 v2.1.1 静的バックテスト分析レポート（細分化版）</h1>
            <p>政策銘柄 + TOPIX_CORE30 | 2020-2025 全価格帯 | RSI（7段階） + 出来高（7段階） + SMA5（6段階）</p>
        </header>
