...
RESULTS_FILE = DATA_DIR / 'v2_1_6_1_backtest_results.parquet'
OUTPUT_HTML = OUTPUT_DIR / 'v2_1_6_1_static_backtest_report.html'
...
def generate_html_report():
    ...
    <head>
        ...
        <title>v2.1.6.1 バックテストレポート（買いシグナル2段階分類・直近1年）</title>
        <style>
            body {{
    ...
    <body>
        <h1>v2.1.6.1 静的バックテストレポート（直近1年）</h1>
        <div class="summary">
            <p><strong>分析期間:</strong> 2024-2025（直近1年）</p>
