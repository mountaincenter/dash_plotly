#!/usr/bin/env python3
"""
v2.0.3静的バックテスト結果のHTML生成
対象: 政策銘柄+CORE30（2020-2025）
ロジック: 前日変化率 + ATRボラティリティ（Grokランク=0、価格帯強制判定なし）
出力: improvement/v2_static_backtest_report.html
"""
...
OUTPUT_FILE = BASE_DIR / 'improvement' / 'v2_static_backtest_report.html'
...
def main():
    ...
    # v2.0.3では使用しない指標（RSI/出来高/SMA5）の分析は除外
...
<body>
    <div class="container">
        <header>
            <h1>📊 v2.0.3 静的バックテスト分析レポート</h1>
            <p>政策銘柄 + TOPIX_CORE30 | 2020-2025 | 前日変化率 + ATRボラティリティ</p>
        </header>
