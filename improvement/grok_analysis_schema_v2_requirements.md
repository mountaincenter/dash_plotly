...
**作成日**: 2025-11-20
**データ期間**: 2025-11-04 〜 2025-11-18（15日間、122件）
**目的**: デイトレードで収益を上げるためのv2スコアリング改善
**現状（v2.0実績）**:
- 売りシグナル（ショート）: 81.8%勝率、+2.52%リターン（18勝4敗）
- 買いシグナル（ロング）: 44.6%勝率、-0.33%リターン（29勝36敗）
...
- **株価帯の影響を考慮していない**（5000-8000円は勝率62.5%なのに加点なし）
...
**v2.0の売りシグナルは既に81.8%勝率で非常に優秀**であり、これを壊すリスクは取れない。
...
|--------|---------|------------|------|
| 0-1000円 | 13 | 76.9% | ✅ 優秀 |
| 1000-2000円 | 3 | 100.0% | ✅ 完璧 |
| 2000-3000円 | 6 | 83.3% | ✅ 優秀 |
| 3000円以上 | 0 | N/A | データなし |
...
| | v2.0（現在） | v2.1（改善後） |
|---|------------|--------------|
| **売りシグナル勝率** | 81.8% | 80%以上（維持） |
| **買いシグナル勝率** | 44.6% | **50-55%**（目標） |
| **使用カラム** | 8カラム | 12カラム（+4） |
...
- 2025-11-20: v2.0.1追加（価格帯スコア補正、カラム追加なし、買い勝率50-55%目標）
- 2025-11-20: **v2.0実績を正確な数値に修正**（データ期間2025-11-04〜11-18、売り81.8%/買い44.6%）
