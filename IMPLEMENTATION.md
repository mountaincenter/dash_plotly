...
| B4 | 乖離 < -15%, 陽線, 急騰フィルター(SMA20<+15% & SMA60<+20% & SMA100<+30%) |

### B4除外ルール（エントリー回避条件）

| ルール | 条件 | 根拠 |
|--------|------|------|
| R1 | VI30-40 × CMEギャップ膠着(-1~+1%) | PF0.94 |
| R2 | N225当日変化率 < -3% | PF1.00 |
| R3 | VI30-40 × CMEギャップGU(>+1%) | PF0.94 |

### 曜日

金曜シグナルはPF1.89で有意に弱い（p<0.001）。週末リスクを挟むため。
...
| ストップロス | なし |
| MAX_HOLD | **全ルール15日**（資本効率最大: 全期間+直近2年検証で確定） |
