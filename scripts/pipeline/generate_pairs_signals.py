...
# 個別除外ペア
# [PERM] = 恒久除外 (上場リスク・PF破綻)、[TEMP:YYYY-MM-DD] = 一時除外 (月末health checkで再評価)
EXCLUDE_PAIRS = {
    ("2768.T", "8020.T"),  # [PERM] full_PF=0.87, recent_PF=0.64
    ("6103.T", "6305.T"),  # [PERM] full_PF=0.70, recent_PF=0.80
    ("6103.T", "6473.T"),  # [PERM] full_PF=0.52, recent_PF=0.30
    ("7167.T", "8411.T"),  # [PERM] full_PF=0.77, recent_PF=0.56
    ("7272.T", "7313.T"),  # [PERM] full_PF=0.82, recent_PF=0.73
    ("8031.T", "8058.T"),  # [PERM] full_PF=0.84, recent_PF=0.35
    ("8306.T", "8316.T"),  # [PERM] full_PF=0.72, recent_PF=0.37
    ("8338.T", "8399.T"),  # [PERM] full_PF=0.88, recent_PF=0.77
    ("8354.T", "8381.T"),  # [PERM] full_PF=0.95, recent_PF=0.89
    ("8360.T", "8386.T"),  # [PERM] full_PF=0.89, recent_PF=0.77
    ("8386.T", "8392.T"),  # [PERM] full_PF=0.90, recent_PF=0.66
    ("8411.T", "8524.T"),  # [PERM] full_PF=0.56, recent_PF=0.54
    ("6995.T", "7282.T"),  # [PERM] 2y_PF=1.37→6m_PF=0.36 劣化明確
