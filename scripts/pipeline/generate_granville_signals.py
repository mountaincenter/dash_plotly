...
def main() -> int:
    ...
    try:
        ...
        print(f"[OK] Saved {len(signals)} signals to {OUTPUT_PATH}")

        # S3アップロードはupdate_manifestで一括実行されるため、ここでは不要
        # (UPLOAD_FILESに granville_ifd_signals.parquet を追加済み)
