...
morning_volume + 前日・前々日のデータを追加して分析用parquetを作成する。

出力: test_output/test_grok_analysis_base_20251107_v3.parquet
"""
...
OUTPUT_PATH = OUTPUT_DIR / 'test_grok_analysis_base_20251107_v3.parquet'
...
def main():
    logger.info("Starting Grok analysis base data creation (v3)...")
