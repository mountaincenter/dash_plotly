...
UNIVERSE = {
    ...
    "6526": ("ソシオネクスト", "A", "ASIC/SoC設計", "tradable"),
    "6723": ("ルネサス", "A", "マイコン/アナログ", "tradable"),
    "285A": ("キオクシア", "A", "NAND", "indicator"),
    "6963": ("ローム", "A", "SiC/パワー半導体", "tradable"),
    "6503": ("三菱電機", "A", "パワー半導体/重電", "tradable"),
    "6504": ("富士電機", "A", "パワー半導体", "tradable"),
    "6501": ("日立製作所", "A/B", "検査装置/電力", "tradable"),
    "6971": ("京セラ", "B", "パッケージ/電子部品", "tradable"),
    "6762": ("TDK", "B", "電子部品/受動部品", "tradable"),
    "2802": ("味の素", "B", "ABF/パッケージ材料", "tradable"),
    "7911": ("TOPPAN", "B", "半導体パッケージ/フォトマスク", "tradable"),
    "7912": ("大日本印刷", "B", "フォトマスク/電子材料", "tradable"),
    "6368": ("オルガノ", "B", "超純水/工場インフラ", "tradable"),
    "8088": ("岩谷産業", "B", "産業ガス/水素", "tradable"),
