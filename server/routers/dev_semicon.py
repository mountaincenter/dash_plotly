...
UNIVERSE = [
    ...
    SemiconStock("6526", "ソシオネクスト", "A", "ASIC/SoC設計"),
    SemiconStock("6723", "ルネサス", "A", "マイコン/アナログ"),
    SemiconStock("285A", "キオクシア", "A", "NAND"),
    SemiconStock("6963", "ローム", "A", "SiC/パワー半導体"),
    SemiconStock("6503", "三菱電機", "A", "パワー半導体/重電"),
    SemiconStock("6504", "富士電機", "A", "パワー半導体"),
    SemiconStock("6501", "日立製作所", "A/B", "検査装置/電力"),
    SemiconStock("6971", "京セラ", "B", "パッケージ/電子部品"),
    SemiconStock("6762", "TDK", "B", "電子部品/受動部品"),
    SemiconStock("2802", "味の素", "B", "ABF/パッケージ材料"),
    SemiconStock("7911", "TOPPAN", "B", "半導体パッケージ/フォトマスク"),
    SemiconStock("7912", "大日本印刷", "B", "フォトマスク/電子材料"),
    SemiconStock("6368", "オルガノ", "B", "超純水/工場インフラ"),
    SemiconStock("8088", "岩谷産業", "B", "産業ガス/水素"),
...
SEGMENT_GROUPS = {
    "半導体主力": {"NAND", "ASIC/SoC設計", "SiC/パワー半導体", "成膜装置", "テスタ/検査", "後工程装置", "エッチング/成膜/塗布", "EUVマスク検査", "洗浄装置"},
    "AIインフラ": {"光通信/高密度配線", "光通信/電力ケーブル/冷却", "MLCC/電源部品/EMI", "電子部品/受動部品", "パッケージ基板", "パッケージ/電子部品", "半導体パッケージ/フォトマスク", "マイコン/アナログ", "ASIC/SoC設計", "成膜装置"},
    "電力": {"検査装置/電力", "パワー半導体/重電", "パワー半導体", "SiC/パワー半導体", "光通信/電線", "電線/電力ケーブル"},
    "光通信": {"光通信/高密度配線", "光通信/電力ケーブル/冷却", "光通信/電線", "電線/電力ケーブル"},
    "冷却/空調": {"冷却/空調", "空調/クリーンルーム"},
    "材料/基板": {"パッケージ基板", "パッケージ/電子部品", "ABF/パッケージ材料", "半導体パッケージ/フォトマスク", "フォトマスク/電子材料", "フォトレジスト", "パッケージ/CMP材料", "シリコンウエハ"},
    "工場インフラ": {"超純水/工場インフラ", "産業ガス/水素", "設備/EPC", "空調/クリーンルーム"},
